...
C
C       The coding of the Gosia suite of codes was maintained by Tomasz Czosnyka 
C       from 1980 until his untimely death in 2006. Since 2007 Nigel Warr has 
C       upgraded and maintained the coding of Gosia and Gosia2. 
C
...
C
C          (7 November 2011, N. Warr) gosia-20081208.11
C            - Fix a bug in the collision functions for lambda=6 mu=3
...
C            Incorporated the internal conversion coefficient program BrIcc as OP,BRIC
C            Provided option to make CONV use the file generated by OP,BRIC
C            Increased the number of energy levels from 75 to 100.
C            Reordered the declarations for each common block to facilitate building singl program file.
C            Added variable to Gosia to reduce differences between Gosia and Gosia2.
C  
C          (8 May 2008, N. Warr) gosia-20080508
C            Increased number of matrix elements from 500 to 999
C            Added OP,SELE to incorporate the separate program SELECT into Gosia.
C
