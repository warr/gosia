...
angle or excitation energy is exceeded, or in {\em LOAD} if there are too
...
\item INTEGER*4 LP3 - maximum number of levels = 100.
\item INTEGER*4 LP4 - maximum number of yields = 1500.
\item INTEGER*4 LP6 - maximum number of $\gamma$ detectors = 32.
\item INTEGER*4 LP7 - end of zeta coupling coefficients
\item INTEGER*4 LP8 - maximum space for collision functions (4900)
\item INTEGER*4 LP9 - length of ZETA array - 2800.
\item INTEGER*4 LP10 - maximum number of substates = 1200.
\item INTEGER*4 LP11 - space for statistical tensors (LP3*28=2800)
