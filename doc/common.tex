...
possible different values of $\omega$. It is used in the functiosn {\em
EXPON} and {\em SETIN}.\\
...
\begin{itemize}
\item REAL*8 ARM(600,7) - reduced matrix elements.
\end{itemize}
...
\item INTEGER*4 LP7 - offset of collision functions in ZETA array.
...
changed using the OP,CONT flag WRN but it isn't used anywhere in the code!
