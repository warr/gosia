...
c     This routine is to read the electric collision functions from the COLLIS array and print
...
c     Look at how LAIAMP uses the COLLIS array.
...
c     test to here
      ...
      DO k = 1 , mimmex
         ...
         collfunc = COLLIS(nind)  ! These are the collision functions
